...
class Organization implements Serializable {
    ...
    static private Date creationDate = Date.valueOf(LocalDate.now());
    ...
    void setCreationDate(Date data){
        creationDate = data;
    }
    void setAnnualTurnover(int at){
    ...
    //GETTERS
    static Date getCreationDate(){ return creationDate;}
    int getId(){
        return this.id;
    }
    String getName(){
